...
:warning:**IMPORTANT UPDATE** April 14, 2019:warning:
*In my original version of this post, I highly recommended several DataCamp courses because they were relatively inexpensive and I truly enjoyed them. I am now rescinding my recommendation of this platform. It has come to my attention that they have [very poorly handled](https://twitter.com/no_reply/status/1113923302915837958) an issue of sexual assault by one of their executives on an employee and that is not the kind of behavior I can condone. They have also released a "[Note to the Community](https://www.datacamp.com/community/blog/note-to-our-community)" (after months of pressure from the instructors on the platform) regarding these issues which indicates that the harasser received little to no consequences for their action, the target of the harassment was not given any resources to make them or others feel more safe (in fact, their note is filled with victim-blaming language), AND the note has been [non-indexed](https://twitter.com/noamross/status/1116709899159916544), meaning that it won't be surfaced in search engines. This complete cover-up is [unacceptable](https://t.co/SHp16vOiU9) and I no longer recommend using the DataCamp platform. Folks are compiling some alternatives [here](https://twitter.com/EngelhardtCR/status/1116743032492253185)*
...
<div class = "dc">
*DataCamp's unacceptable response (see beginning of post for details). If you can afford to do so, please don't support them. [Here's one of many alternatives](https://rstudio.cloud/learn/primers/1).*
</div>

    
* ~~**Intermediate R** by DataCamp~~
<div class = "dc">
*DataCamp's unacceptable response (see beginning of post for details). If you can afford to do so, please don't support them.*
</div>
...
<div class = "dc">
*DataCamp's unacceptable response (see beginning of post for details). If you can afford to do so, please don't support them. [Here's one of many alternatives](https://rstudio.cloud/learn/primers/6).*
</div>
