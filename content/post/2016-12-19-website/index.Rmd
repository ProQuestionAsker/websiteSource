...
knitr::include_graphics("frontmatter.png")
```
...
knitr::include_graphics("clonerepo.png")
```
...
```{r echo = FALSE, out.width = "80%", fig.align = "center"}
knitr::include_graphics("clonerepo2.png")
```
...
```{r echo = FALSE, out.width = "80%", fig.align = "center"}
knitr::include_graphics("newsite.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("folders.png")
```
...
```{r echo = FALSE, out.width = "50%", fig.align = "center"}
knitr::include_graphics("createbranch.png")
```
...
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("sourcesbranch.png")
```
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("masterbranch.png")
```
...
knitr::include_graphics("navlinks.png")
```
...
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("listfile.png")
```
...
```{r echo = FALSE, out.width = "60%", fig.align = "center"}
knitr::include_graphics("newblog.png")
```
Great! So let's use `serve_site()` to check out the page. 
```{r echo = FALSE, out.width = "80%", fig.align = "center"}
knitr::include_graphics("newblog2.png")
```
...
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("missingimage.png")
```
...
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("newblog3.png")
```
That's better!
...
```{r echo = FALSE, out.width = "50%", fig.align = "center"}
knitr::include_graphics("pfrontmatter.png")
```
And our home page now contains this:
```{r echo = FALSE, out.width = "90%", fig.align = "center"}
knitr::include_graphics("pfrontmatter2.png")
```
