...
This was a hard pill to swallow because it meant that maybe this dream, the only one I'd ever had for my career, wasn't so perfect after all. At first, I told myself that I could keep doing it. I could take that job that pays next to nothing, in a part of the country I didn't want to move to, doing work I wasn't interested in so that I could remain ✨.a marine biologist ✨. It seemed like losing the title would be admitting that I had failed at my biggest dream.
...
```{r echo = FALSE, out.width = "50%", fig.show = "hold", fig.caption = "Testing"}
knitr::include_graphics("oatmeal_unhappy.png")
knitr::include_graphics("oatmeal_unhappy2.png")
```
...
>"... _almost_ doesn't have to be a bad thing. You can try your hardest to change something - exhaust every possibility - and sometimes it's still not enough. But _almost_ means you were there. You did all you could."
...
This post reflects my personal experiences in career-switching and I recognize how lucky and privileged I am to even have this story to tell. I'm lucky that my parents have been insanely supportive my whole life and have always been my biggest cheerleaders. I'm also lucky that my boyfriend helped me in every way with my career change, it literally would not have been possible without him and his additional cheerleading. I'm privileged that I had the ability to take the educational paths I took and then decide to switch to something new. If I can now use some of that luck/privilege from this side of the "career-switching" door to help hold it open for you, let me know. I'll do my very best to help.   