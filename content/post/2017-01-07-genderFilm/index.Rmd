---
title: Gender Parity and Dialogue in 2016’s Highest Grossing Films
authors: 
  - Amber Thomas
date: '2017-01-07'
slug: genderFilm
...
tags:
  ...
  - d3.js
buttons:
  - link: 'http://amber.rbind.io/2016MovieDialogue/'
    text: Interactive Graphic
description: 'Text parsing, analytics, and d3.js interactive data visualization of movie transcripts'
disqus: 'true'
thumbnail: 'thumbnail.jpg'
image: 'film.jpg'
imageAlt: 'Two film reels against a patterned background'
imageCredit: 'Noom Peerapong'
imageCreditLink: 'https://unsplash.com/photos/2uwFEAGUm6E'
type: ''
aliases:
  - /projects/2017/01/07/gendermoviedialogue/
---
...
![Scatter plot showing total number of words spoken per character compared to the number of times that character spoke at all.](figure1.png) \
...
knitr::include_graphics("JB_Baloo.jpg")
```
...
```{r echo = FALSE, out.width = "80%", fig.align = "center"}
knitr::include_graphics("Zootopia_Sloth.jpg")
```
...
![Bar chart showing the number of words spoken by each character.](figure2.png) \
...
knitr::include_graphics("RO_V1.jpg")
```
...
```{r echo = FALSE, out.width = "30%", fig.align = "center"}
knitr::include_graphics("RO_V2.jpg")
```
...
```{r echo = FALSE, out.width = "30%", fig.align = "center"}
knitr::include_graphics("RO_V3.jpg")
```
...
```{r echo = FALSE, out.width = "30%", fig.align = "center"}
knitr::include_graphics("FinalDesign.jpg")
```
...
knitr::include_graphics("ColorScheme1.png")
knitr::include_graphics("ColorScheme2.png")
knitr::include_graphics("ColorScheme3.png")
```
